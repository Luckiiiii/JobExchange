...
namespace JobExchange.Migrations
{
    ...
    [Migration("20230718062652_typeJob")]
    partial class typeJob
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobExchange.Models.TypeJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobExchange.Models.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("JobExchange.Models.Employer", b =>
                {
                    b.HasOne("JobExchange.Models.StoreUser", "User")
                        .WithMany("Employers")
            ...
            modelBuilder.Entity("JobExchange.Models.JobInfo", b =>
                {
                    ...
                    b.HasOne("JobExchange.Models.TypeJob", "TypeJob")
                        .WithMany("JobInfos")
